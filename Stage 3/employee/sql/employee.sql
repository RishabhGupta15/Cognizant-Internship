...
insert into employee (em_name,em_salary,em_permanent,em_date_of_birth,em_dp_id) values ("Siraj",20000 ,true ,"1991-07-10" ,1);
insert into employee (em_name,em_salary,em_permanent,em_date_of_birth,em_dp_id) values ("Kohli",240000 ,true ,"1987-01-23" ,2);
insert into employee (em_name,em_salary,em_permanent,em_date_of_birth,em_dp_id) values ("Dhoni",240000 ,true ,"1989-05-13" ,1);
insert into employee (em_name,em_salary,em_permanent,em_date_of_birth,em_dp_id) values ("Virat",50000 ,false ,"1993-10-11" ,2);
